    ...
    for e in range(MAX_TRAIN_EPISODE):
        ...
        while not game.is_episode_finished():
            ...
            if len(replay_cache) > OBSERVE:
                ...
                y_batch = batch_reward + np.invert(batch_terminal).astype(np.float32) * GAMMA * q_batch[
        ...
        print("*" * 30)
        print("Finish {} th episode at {} th time steps.".format(
            e, t), file=reward_record)
        ...
        if batch_loss is not None:
            print("Mini-batch train loss in {} th episode: {}".format(e,
                                                                      batch_loss), file=reward_record)
            print("Mini-batch train loss in {} th episode: {}".format(e, batch_loss))
        print("Size of Replay Cache: {}".format(
            len(replay_cache)), file=reward_record)

...
class Worker():
    def __init__(self,game,name,s_size,a_size,trainer,model_path,global_episodes):
        ...
        game.set_doom_scenario_path("defend_the_line.wad") #This corresponds to the simple task we will pose our agent
...
class Player():
    ...
    def play(self,sess, episode_num):
        #episode_count = sess.run(self.global_episodes)
        ...
        with sess.as_default(), sess.graph.as_default():                 
            while True:
                ...
                print("defend the line player: {}, episode: {}, reward: {}, steps: {}".format(self.number, episode_count, episode_reward, episode_step_count))
